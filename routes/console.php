...
Artisan::command('export-contract-logs', function () {
    $contractLogs = App\ContractLog::withGlobalScope('role', new App\Scopes\ContractLogScope)->leftJoin('tContractStatus', 'tContractLogs.statusId', '=', 'tContractStatus.id')
    ...
    Maatwebsite\Excel\Facades\Excel::create('Contract Logs', function($excel) use ($contractLogs, $headers){
